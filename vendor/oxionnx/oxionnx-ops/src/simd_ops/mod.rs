// Modified by the GIMP LaMa inpainting fork of OxiONNX (2026-09): exports the new SIMD wrappers.
...
pub use functions::{
    simd_abs, simd_add, simd_batch_norm_channel, simd_div, simd_div_scalar, simd_dot_product, simd_exp, simd_gelu, simd_layer_norm,
