// Modified by the GIMP LaMa inpainting fork of OxiONNX (2026-09): re-exports the add_batchnorm fusion pass.
...
pub use conv::{
    fold_batch_norm_inference, fuse_add_batchnorm, fuse_conv_add_relu, fuse_conv_batchnorm,
